// Consts
const apikey = "32f264652c106575541e7b44d6db335d";
...
const apiPaths = {
    ...
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyDiqjn9Pl0UMrAIVHTe0Arq4NQ35NrM3zI`
}
...
function searchMovieTrailer(movieName, iframId) {
    ...
    .then(res => {
        ...
        iframe.width = "245px";
        iframe.height = "150px";
        iframe.src = `https://www.youtube.com/embed/${bestResult.id.videoId}?&controls=0`;
        elements.appendChild(iframe);
